...
CLASS lhc_Order IMPLEMENTATION.
  ...
  METHOD SendOrder.
    ...
    READ ENTITIES OF zi_as_order IN LOCAL MODE
    ENTITY Order
  ...
  METHOD updateFields.
    ...
    LOOP AT lt_data ASSIGNING FIELD-SYMBOL(<lf_data>).
        ...
        MODIFY ENTITIES OF zi_as_order IN LOCAL MODE
        ENTITY Order
        UPDATE
